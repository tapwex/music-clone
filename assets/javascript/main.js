    ...
    songsData : [
        {
            ...
            name: 'Anh Chẳng Thể',
            singer: 'Phạm Kỳ',
            pathSong: './assets/music/list-song/anhchangthe.mp3',
            duration : '04:27',
        },
        {
        ...
        if (toatMain) {
            ...
            toast.innerHTML = `
                <div class="toast__item">
                    ...
                    <span>Cảm ơn bạn đã ấn vô nhưng tụi mình đang phát triển tính năng này , xin cảm ơn !</span>
                    <p>tụi mình đang ád</p>
                </div>
            `;
